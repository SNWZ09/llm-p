...
Я не очень понял, как нормально вставить картинки в README.md, надеюсь, сделал все правильно.
 
### 1. Регистрация пользователя
![Регистрация пользователя](screenshots/1 Регистрация.png)
...
![Логин пользователя](screenshots/2 Логин.png)
Тут тоже все нормально. Ввели юзернейм, пароль и снизу получили токен.

### 3. Авторизация пользователя
![Авторизация пользователя 1](screenshots/3 Авторизация.png)
![Авторизация пользователя 2](screenshots/4 Авторизация.png)

На этих фото видна успешная авторизация с помощью токена, юзернейма и пароля.

### 4. Запрос пользователя
![Запрос пользователя](screenshots/5 Запрос.png)
...
![История запросов пользователя](screenshots/6 История сообщений.png)

На скрине видна малая часть всех моих попыток заставить подключение к нейросети работать.
Ниже я напишу все свои запросы-попытки исправить ситуацию.
...
![Удаление истории запросов пользователя 1](screenshots/7 История удалена.png)
![Удаление истории запросов пользователя 2](screenshots/8 История удалена.png)
